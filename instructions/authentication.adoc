...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/policy-jwt.yaml
----
...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/policy-jwt.yaml
----
...
spec:
  ...
  inclusion:
    namespaces: ["{{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }}"]
----
...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/authorization-enable-rbac.yml
----
...
Note the ServiceRole `service-viewer` is bound to the `{{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }}`
...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/namespace-rbac-policy.yml
----
...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/namespace-rbac-policy.yml
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/authorization-enable-rbac.yml
----
