...
[source,bash,role="execute-1"]
----
oc exec -n smcp-{{ OCP_USERNAME }} -c recommendation $(oc get pod -n smcp-{{ OCP_USERNAME }} -l 'app=recommendation,version=v2' -o jsonpath='{..metadata.name}') -- curl -s localhost:8080/misbehave
----
...
[source,bash,role="execute-1"]
----
oc exec -n smcp-{{ OCP_USERNAME }} -c recommendation $(oc get pod -n smcp-{{ OCP_USERNAME }} -l 'app=recommendation,version=v2' -o jsonpath='{..metadata.name}') -- curl -s localhost:8080/behave
----
...
[source,bash,role="execute-1"]
----
oc exec -n smcp-{{ OCP_USERNAME }} -c recommendation $(oc get pod -n smcp-{{ OCP_USERNAME }} -l 'app=recommendation,version=v2' -o jsonpath='{..metadata.name}') -- curl -s http://localhost:8080/timeout?timeout=3
----
...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} create -f  https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-timeout.yml
----
...
[source,bash,role="execute-1"]
----
oc exec -n smcp-{{ OCP_USERNAME }} -c recommendation $(oc get pod -n smcp-{{ OCP_USERNAME }} -l 'app=recommendation,version=v2' -o jsonpath='{..metadata.name}') -- curl -s http://localhost:8080/timeout?timeout=0
----
...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} delete -f  https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-timeout.yml
----
...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} apply -f  https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-split.yml
----
...
[source,bash,role="execute-1"]
----
oc apply -n smcp-{{ OCP_USERNAME }} -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/destination-rule-recommendation_cb_policy_version_v2.yml
----
...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} delete -f  https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-split.yml
----
