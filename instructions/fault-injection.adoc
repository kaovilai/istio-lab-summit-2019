...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} get pods -l app=recommendation
----
...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-503.yml
----
...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-503.yml
----
...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-delay.yml
----
...
[NOTE]
====
Use `oc get pods -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }}` to find the `recommendation` pods to look at the logs.
====

[source,bash,subs="+macros,+attributes",role="copypaste copypaste-warning"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} logs -f recommendation-v#-XXXXXXXXXXXX -c recommendation
----
...
* Namespace: {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }}
* Service: recommendation.{{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }}
...
[source,bash,role="execute-1"]
----
oc -n {{ PERUSER_ISTIO_TUTORIAL_PROJECTNAME }} delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-delay.yml
----
