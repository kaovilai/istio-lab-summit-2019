...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} get pods -l app=recommendation
----
...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-503.yml
----
...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-503.yml
----
...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} create -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-delay.yml
----
...
[NOTE]
====
Use `oc get pods -n smcp-{{ OCP_USERNAME }}` to find the `recommendation` pods to look at the logs.
====

[source,bash,subs="+macros,+attributes",role="copypaste copypaste-warning"]
----
oc -n smcp-{{ OCP_USERNAME }} logs -f recommendation-v#-XXXXXXXXXXXX -c recommendation
----
...
* Namespace: smcp-{{ OCP_USERNAME }}
* Service: recommendation.smcp-{{ OCP_USERNAME }}
...
[source,bash,role="execute-1"]
----
oc -n smcp-{{ OCP_USERNAME }} delete -f https://raw.githubusercontent.com/thoraxe/istio-lab-summit-2019/master/src/istiofiles/virtual-service-recommendation-delay.yml
----
